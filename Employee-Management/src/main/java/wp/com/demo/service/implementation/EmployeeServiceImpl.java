...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    @Transactional
    public Optional<Employee> save(String name, String surname,String embg,String email, String street,String city,String country,String jobTitle,String department,Date employmentDate,String status,
        ...
        return Optional.of(this.employeeRepository.save(new Employee(name, surname, embg, email,street, city, country, jobTitle, department, employmentDate,status,
                 phone, projects, salary, experience)));
    }

    @Override
    @Transactional
    public Optional<Employee> edit(Long id, String name, String surname,String embg,String email, String street,String city,String country,String jobTitle,String department,Date employmentDate,String status,
                                   String phone,Integer projects, Integer salary,Integer experience) {
